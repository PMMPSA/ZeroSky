...
class Main extends PluginBase implements Listener {
    ...
    public function onEnable() {
        ...
        $this->getLogger()->info("
          ...
          §7§l=[ §r§a================================================================================== §7§l]=
                            ...
                            §ePlugin By Server Zerosky (được làm dựa theo plugin minelevel bên mysu,ngoài sói ra ai cắp bản quyền bố đánh phát chết luôn :v)
	...
	public function onChat(PlayerChatEvent $event){
		...
		$p = $event->getPlayer();
		$n = $p->getName();
		$p->setDisplayName("§7[§e". $config->get('level')."§7]§r " .$n);
	}
