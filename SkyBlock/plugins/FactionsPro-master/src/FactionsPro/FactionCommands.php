        ...
        if ($sender instanceof Player) {
            ...
            if (strtolower($command->getName()) === "g") {
                if (empty($args)) {
                    ...
                    if ($args[0] == "war") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g war <faction name:tp>"));
                            return true;
                        }
                            ...
                            foreach ($this->plugin->getServer()->getOnlinePlayers() as $p) {
                                if ($this->plugin->getPlayerFaction($p->getName()) == $factionName) {
                                    if ($this->plugin->getLeader($factionName) == $p->getName()) {
                                        $p->sendMessage("$sFaction wants to start a war, '/g war $sFaction' to start!");
                    ...
                    if (strtolower($args[0]) == 'addstrto') {
                        if (!isset($args[1]) or ! isset($args[2])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g addstrto <faction> <STR>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("The requested faction doesn't exist."));
                    ...
                    if (strtolower($args[0]) == 'pf') {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g pf <player>"));
                            return true;
                        }
                    ...
                    if (strtolower($args[0] == "membersof")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g membersof <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("The requested faction doesn't exist"));
                    ...
                    if (strtolower($args[0] == "officersof")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g officersof <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("The requested faction doesn't exist"));
                    ...
                    if (strtolower($args[0] == "leaderof")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g leaderof <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("The requested faction doesn't exist"));
                    ...
                    if (strtolower($args[0] == "say")) {
                        if (true) {
                            $sender->sendMessage($this->plugin->formatMessage("/g say is disabled"));
                            return true;
                        }
                        if (!($this->plugin->isInFaction($playerName))) {
                    ...
                    if (strtolower($args[0] == "enemywith")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g enemywith <faction>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("You must be in a faction to do this"));
				...
				if (strtolower($args[0] == "notenemy")) {
					if (!isset($args[1])) {
						$sender->sendMessage($this->plugin->formatMessage("Usage: /g notenemy <faction>"));
						return true;
					}
					if (!$this->plugin->isInFaction($playerName)) {
						$sender->sendMessage($this->plugin->formatMessage("You must be in a faction to do this"));
                    ...
                    if (strtolower($args[0] == "allywith")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g allywith <faction>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("You must be in a faction to do this"));
                    ...
                    if (strtolower($args[0] == "breakalliancewith") or strtolower($args[0] == "notally")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g breakalliancewith <faction>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("You must be in a faction to do this"));
                ...
                if (strtolower($args[0]) == "help") {
                        $sender->sendMessage(TextFormat::RED . "\n/g about\n/g accept\n/g overclaim [Takeover the plot of the requested faction]\n/g claim\n/g create <name>\n/g del\n/g demote <player>\n/g deny");
                        $sender->sendMessage(TextFormat::RED . "\n/g home\n/g help <page>\n/g info\n/g info <faction>\n/g invite <player>\n/g kick <player>\n/g leader <player>\n/g leave");
                        $sender->sendMessage(TextFormat::RED . "\n/g sethome\n/g unclaim\n/g unsethome\n/g ourmembers - {Members + Statuses}\n/g ourofficers - {Officers + Statuses}\n/g ourleader - {Leader + Status}\n/g allies - {The allies of your faction");
                        $sender->sendMessage(TextFormat::RED . "\n/g desc\n/g promote <player>\n/g allywith <faction>\n/g breakalliancewith <faction>\n\n/g allyok [Accept a request for alliance]\n/g allyno [Deny a request for alliance]\n/g allies <faction> - {The allies of your chosen faction}");
                        $sender->sendMessage(TextFormat::RED . "\n/g membersof <faction>\n/g officersof <faction>\n/g leaderof <faction>\n/g say <send message to everyone in your faction>\n/g pf <player>\n/g topfactions");
                        $sender->sendMessage(TextFormat::RED . "\n/g forceunclaim <faction> [Unclaim a faction plot by force - OP]\n\n/g forcedelete <faction> [Delete a faction by force - OP]");
                        return true;
                }
                return true;
            }
