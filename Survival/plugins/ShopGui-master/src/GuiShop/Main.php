...
public $Blocks = [
    ...
    "Acacia Wood" => [162,0,50,15],
	"Cobblestone" => [4,0,10,2],
	"Grass" => [2,0,5,1],
	"Obsidian" => [49,0,100,25],
	"Bedrock" => [7,0,9999999999999999999999999999999,0],
	"Sand " => [12,0,150,45],
    "Sandstone " => [24,0,100,50],
	"Nether Rack" => [87,0,500,15],
    "Glass" => [20,0,150,100],
    "Glowstone" => [89,0,100,25],
    ...
    "End Stone" => [121,0,200,60],
    "Emerald Block" => [133,0,350,35],
    "Diamond Block" => [57,0,300,35],
    "Iron Block" => [42,0,299,40],
    "Gold Block" => [41,0,299,40],
    "Purpur Blocks" => [201,0,201,25],
    ...
    "Quartz Block" => [155,0,201,25]
  ];

  public $Ores = [
    "ICON" => ["Ores",266,0],
    "Coal" => [263,0,400,10],
    "Iron Ingot" => [265,0,600,40],
    "Gold Ingot" => [266,0,300,40],
	"RedStone" => [331,0,300,30],
    "Diamond" => [264,0,350,40]
  ];
  ...
  public $Mobs = [
    "ICON" => ["Mobs",52,0],
    "Blaze" => [383,94,5000,1000],
    "Creeper" => [383,33,5000,1000],
    "Zombie" => [383,32,5000,1000],
    "Husk" => [383,47,5000,1000],
    "Zombie_Pigman" => [383,36,5000,1000],
	"Skeleton" => [383,34,5000,1000],
	"Spider" => [383,35,5000,1000],
    "Mob Spawner" => [52,0,7500,2000]
  ];
  ...
  public function sendConfirm(Player $player, $id){
    ...
    $slider = new Slider("Số lượng ",1,64,1);
